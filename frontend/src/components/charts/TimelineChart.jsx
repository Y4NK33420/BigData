      ...
      <ComposedChart data={chartData} margin={{ top: 4, right: 12, bottom: 0, left: 0 }}>
        <defs>
          <linearGradient id="ytGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#F17DAC" stopOpacity={0.42} />
            <stop offset="100%" stopColor="#F17DAC" stopOpacity={0} />
          </linearGradient>
          <linearGradient id="rdGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#A887CE" stopOpacity={0.36} />
        ...
        <Area type="monotone" dataKey="YouTube Views" stroke="#F17DAC" fill="url(#ytGrad)" strokeWidth={2.4} dot={false} />
        <Line type="monotone" dataKey="Reddit Score" stroke="#A9B5FF" strokeWidth={2.2} dot={false} />
        <Brush dataKey="date" height={22} stroke="var(--border)" fill="rgba(31,32,41,0.96)" travellerWidth={6} style={{ fontSize: '0.7rem' }} />
      </ComposedChart>
    </ResponsiveContainer>
  )
}
